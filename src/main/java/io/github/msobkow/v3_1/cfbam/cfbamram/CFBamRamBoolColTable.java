	...
	implements ICFBamBoolColTable
{
	...
	public void createBoolCol( ICFSecAuthorization Authorization,
		ICFBamBoolCol Buff )
	{
		...
		CFBamBuffBoolColByTableIdxKey keyTableIdx = schema.getFactoryBoolCol().newTableIdxKey();
	...
	public ICFBamBoolCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamBoolCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffBoolColByTableIdxKey key = schema.getFactoryBoolCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamBoolCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamBoolCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamBoolCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamBoolCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamBoolCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamBoolCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamBoolCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamBoolCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamBoolCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamBoolCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamBoolCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamBoolCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamBoolCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamBoolCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamBoolCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamBoolCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateBoolCol( ICFSecAuthorization Authorization,
		ICFBamBoolCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamBoolCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffBoolColByTableIdxKey existingKeyTableIdx = schema.getFactoryBoolCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffBoolColByTableIdxKey newKeyTableIdx = schema.getFactoryBoolCol().newTableIdxKey();
		...
		ICFBamBoolColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamBoolCol> matchSet = new LinkedList<ICFBamBoolCol>();
		Iterator<ICFBamBoolCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamBoolCol> iterMatch = matchSet.iterator();
