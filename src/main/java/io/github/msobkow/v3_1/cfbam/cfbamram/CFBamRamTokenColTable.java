	...
	implements ICFBamTokenColTable
{
	...
	public void createTokenCol( ICFSecAuthorization Authorization,
		ICFBamTokenCol Buff )
	{
		...
		CFBamBuffTokenColByTableIdxKey keyTableIdx = schema.getFactoryTokenCol().newTableIdxKey();
	...
	public ICFBamTokenCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamTokenCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTokenColByTableIdxKey key = schema.getFactoryTokenCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamTokenCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamTokenCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTokenCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTokenCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamTokenCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamTokenCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamTokenCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamTokenCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamTokenCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTokenCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTokenCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTokenCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTokenCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamTokenCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamTokenCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamTokenCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateTokenCol( ICFSecAuthorization Authorization,
		ICFBamTokenCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamTokenCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTokenColByTableIdxKey existingKeyTableIdx = schema.getFactoryTokenCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTokenColByTableIdxKey newKeyTableIdx = schema.getFactoryTokenCol().newTableIdxKey();
		...
		ICFBamTokenColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamTokenCol> matchSet = new LinkedList<ICFBamTokenCol>();
		Iterator<ICFBamTokenCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamTokenCol> iterMatch = matchSet.iterator();
