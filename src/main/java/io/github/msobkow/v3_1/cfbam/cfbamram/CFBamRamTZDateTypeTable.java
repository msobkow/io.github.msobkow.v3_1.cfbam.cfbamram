	...
	implements ICFBamTZDateTypeTable
{
	 ...
	 */
	public ICFBamTZDateType[] pageRecBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	...
	public ICFBamTZDateType updateTZDateType( ICFSecAuthorization Authorization,
		ICFBamTZDateType iBuff )
	{
		CFBamBuffTZDateType Buff = (CFBamBuffTZDateType)schema.getTableTZDateDef().updateTZDateDef( Authorization,	Buff );
		...
		ICFBamTZDateType iBuff )
	{
		...
		CFBamBuffTZDateType Buff = ensureRec(iBuff);
		int classCode;
