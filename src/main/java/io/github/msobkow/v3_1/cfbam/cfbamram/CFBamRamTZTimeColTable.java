	...
	implements ICFBamTZTimeColTable
{
	...
	public void createTZTimeCol( ICFSecAuthorization Authorization,
		ICFBamTZTimeCol Buff )
	{
		...
		CFBamBuffTZTimeColByTableIdxKey keyTableIdx = schema.getFactoryTZTimeCol().newTableIdxKey();
	...
	public ICFBamTZTimeCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamTZTimeCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTZTimeColByTableIdxKey key = schema.getFactoryTZTimeCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamTZTimeCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamTZTimeCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTZTimeCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTZTimeCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamTZTimeCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamTZTimeCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamTZTimeCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamTZTimeCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamTZTimeCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTZTimeCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTZTimeCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTZTimeCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTZTimeCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamTZTimeCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamTZTimeCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamTZTimeCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateTZTimeCol( ICFSecAuthorization Authorization,
		ICFBamTZTimeCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamTZTimeCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTZTimeColByTableIdxKey existingKeyTableIdx = schema.getFactoryTZTimeCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZTimeColByTableIdxKey newKeyTableIdx = schema.getFactoryTZTimeCol().newTableIdxKey();
		...
		ICFBamTZTimeColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamTZTimeCol> matchSet = new LinkedList<ICFBamTZTimeCol>();
		Iterator<ICFBamTZTimeCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamTZTimeCol> iterMatch = matchSet.iterator();
