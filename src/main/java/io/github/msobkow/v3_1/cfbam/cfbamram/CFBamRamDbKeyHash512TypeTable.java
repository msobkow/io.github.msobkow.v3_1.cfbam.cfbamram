	...
	implements ICFBamDbKeyHash512TypeTable
{
	...
	public ICFBamDbKeyHash512Type updateDbKeyHash512Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Type iBuff )
	{
		CFBamBuffDbKeyHash512Type Buff = (CFBamBuffDbKeyHash512Type)schema.getTableDbKeyHash512Def().updateDbKeyHash512Def( Authorization,	Buff );
		...
		ICFBamDbKeyHash512Type iBuff )
	{
		...
		CFBamBuffDbKeyHash512Type Buff = ensureRec(iBuff);
		int classCode;
