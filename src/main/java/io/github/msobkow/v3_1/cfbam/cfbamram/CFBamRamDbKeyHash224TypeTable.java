	...
	implements ICFBamDbKeyHash224TypeTable
{
	...
	public ICFBamDbKeyHash224Type updateDbKeyHash224Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash224Type iBuff )
	{
		CFBamBuffDbKeyHash224Type Buff = (CFBamBuffDbKeyHash224Type)schema.getTableDbKeyHash224Def().updateDbKeyHash224Def( Authorization,	Buff );
		...
		ICFBamDbKeyHash224Type iBuff )
	{
		...
		CFBamBuffDbKeyHash224Type Buff = ensureRec(iBuff);
		int classCode;
