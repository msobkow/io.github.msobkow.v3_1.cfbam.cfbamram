	...
	implements ICFBamInt64ColTable
{
	...
	public void createInt64Col( ICFSecAuthorization Authorization,
		ICFBamInt64Col Buff )
	{
		...
		CFBamBuffInt64ColByTableIdxKey keyTableIdx = schema.getFactoryInt64Col().newTableIdxKey();
	...
	public ICFBamInt64Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamInt64Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffInt64ColByTableIdxKey key = schema.getFactoryInt64Col().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamInt64Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamInt64Col readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt64Col lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt64Col[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamInt64Col readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamInt64Col readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamInt64Col[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamInt64Col[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamInt64Col[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt64Col[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt64Col[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt64Col[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt64Col[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamInt64Col[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamInt64Col moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamInt64Col moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateInt64Col( ICFSecAuthorization Authorization,
		ICFBamInt64Col Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamInt64Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt64ColByTableIdxKey existingKeyTableIdx = schema.getFactoryInt64Col().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffInt64ColByTableIdxKey newKeyTableIdx = schema.getFactoryInt64Col().newTableIdxKey();
		...
		ICFBamInt64ColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamInt64Col> matchSet = new LinkedList<ICFBamInt64Col>();
		Iterator<ICFBamInt64Col> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamInt64Col> iterMatch = matchSet.iterator();
