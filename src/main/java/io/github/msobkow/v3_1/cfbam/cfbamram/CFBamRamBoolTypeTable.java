	...
	implements ICFBamBoolTypeTable
{
	...
	public void createBoolType( ICFSecAuthorization Authorization,
		ICFBamBoolType Buff )
	{
		...
		CFBamBuffBoolTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryBoolType().newSchemaIdxKey();
	...
	public ICFBamBoolType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamBoolType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffBoolTypeBySchemaIdxKey key = schema.getFactoryBoolType().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamBoolType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamBoolType readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamBoolType lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamBoolType[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamBoolType readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamBoolType readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamBoolType[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamBoolType[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamBoolType[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamBoolType[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamBoolType[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamBoolType[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamBoolType[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamBoolType[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamBoolType moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamBoolType moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateBoolType( ICFSecAuthorization Authorization,
		ICFBamBoolType Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamBoolType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffBoolTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryBoolType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffBoolTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryBoolType().newSchemaIdxKey();
		...
		ICFBamBoolTypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<ICFBamBoolType> matchSet = new LinkedList<ICFBamBoolType>();
		Iterator<ICFBamBoolType> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamBoolType> iterMatch = matchSet.iterator();
