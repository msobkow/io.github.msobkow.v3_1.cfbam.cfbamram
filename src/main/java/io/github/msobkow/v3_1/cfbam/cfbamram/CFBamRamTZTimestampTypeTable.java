	...
	implements ICFBamTZTimestampTypeTable
{
	...
	public ICFBamTZTimestampType updateTZTimestampType( ICFSecAuthorization Authorization,
		ICFBamTZTimestampType iBuff )
	{
		CFBamBuffTZTimestampType Buff = (CFBamBuffTZTimestampType)schema.getTableTZTimestampDef().updateTZTimestampDef( Authorization,	Buff );
		...
		ICFBamTZTimestampType iBuff )
	{
		...
		CFBamBuffTZTimestampType Buff = ensureRec(iBuff);
		int classCode;
