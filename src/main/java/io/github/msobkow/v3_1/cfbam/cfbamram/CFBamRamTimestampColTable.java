	...
	implements ICFBamTimestampColTable
{
	...
	public ICFBamTimestampCol updateTimestampCol( ICFSecAuthorization Authorization,
		ICFBamTimestampCol iBuff )
	{
		CFBamBuffTimestampCol Buff = (CFBamBuffTimestampCol)schema.getTableTimestampDef().updateTimestampDef( Authorization,	Buff );
		...
		ICFBamTimestampCol iBuff )
	{
		...
		CFBamBuffTimestampCol Buff = ensureRec(iBuff);
		int classCode;
