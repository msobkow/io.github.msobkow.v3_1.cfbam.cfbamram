	...
	implements ICFBamDbKeyHash160TypeTable
{
	...
	public ICFBamDbKeyHash160Type updateDbKeyHash160Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash160Type iBuff )
	{
		CFBamBuffDbKeyHash160Type Buff = (CFBamBuffDbKeyHash160Type)schema.getTableDbKeyHash160Def().updateDbKeyHash160Def( Authorization,	Buff );
		...
		ICFBamDbKeyHash160Type iBuff )
	{
		...
		CFBamBuffDbKeyHash160Type Buff = ensureRec(iBuff);
		int classCode;
