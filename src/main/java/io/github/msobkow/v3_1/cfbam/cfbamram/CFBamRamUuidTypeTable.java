	...
	implements ICFBamUuidTypeTable
{
	...
	public void createUuidType( ICFSecAuthorization Authorization,
		ICFBamUuidType Buff )
	{
		...
		CFBamBuffUuidTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryUuidType().newSchemaIdxKey();
	...
	public ICFBamUuidType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamUuidType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUuidTypeBySchemaIdxKey key = schema.getFactoryUuidType().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamUuidType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamUuidType readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUuidType lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUuidType[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamUuidType readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamUuidType readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamUuidType[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamUuidType[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamUuidType[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUuidType[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUuidType[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUuidType[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUuidType[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamUuidType[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamUuidType moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamUuidType moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateUuidType( ICFSecAuthorization Authorization,
		ICFBamUuidType Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamUuidType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUuidTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryUuidType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUuidTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryUuidType().newSchemaIdxKey();
		...
		ICFBamUuidTypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<ICFBamUuidType> matchSet = new LinkedList<ICFBamUuidType>();
		Iterator<ICFBamUuidType> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamUuidType> iterMatch = matchSet.iterator();
