	...
	implements ICFBamDbKeyHash384ColTable
{
	...
	public ICFBamDbKeyHash384Col updateDbKeyHash384Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Col iBuff )
	{
		CFBamBuffDbKeyHash384Col Buff = (CFBamBuffDbKeyHash384Col)schema.getTableDbKeyHash384Def().updateDbKeyHash384Def( Authorization,	Buff );
		...
		ICFBamDbKeyHash384Col iBuff )
	{
		...
		CFBamBuffDbKeyHash384Col Buff = ensureRec(iBuff);
		int classCode;
