	...
	implements ICFBamDbKeyHash384ColTable
{
	...
	public void createDbKeyHash384Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Col Buff )
	{
		...
		CFBamBuffDbKeyHash384ColByTableIdxKey keyTableIdx = schema.getFactoryDbKeyHash384Col().newTableIdxKey();
	...
	public ICFBamDbKeyHash384Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamDbKeyHash384Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash384ColByTableIdxKey key = schema.getFactoryDbKeyHash384Col().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamDbKeyHash384Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamDbKeyHash384Col readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash384Col lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash384Col[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamDbKeyHash384Col readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamDbKeyHash384Col readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamDbKeyHash384Col[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamDbKeyHash384Col[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamDbKeyHash384Col[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash384Col[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash384Col[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash384Col[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash384Col[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamDbKeyHash384Col[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamDbKeyHash384Col moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamDbKeyHash384Col moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateDbKeyHash384Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Col Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamDbKeyHash384Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash384ColByTableIdxKey existingKeyTableIdx = schema.getFactoryDbKeyHash384Col().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash384ColByTableIdxKey newKeyTableIdx = schema.getFactoryDbKeyHash384Col().newTableIdxKey();
	...
	{
		ICFBamDbKeyHash384Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamDbKeyHash384Col> matchSet = new LinkedList<ICFBamDbKeyHash384Col>();
		Iterator<ICFBamDbKeyHash384Col> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamDbKeyHash384Col> iterMatch = matchSet.iterator();
