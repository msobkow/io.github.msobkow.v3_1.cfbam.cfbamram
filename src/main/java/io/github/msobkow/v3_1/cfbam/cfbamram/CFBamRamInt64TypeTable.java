	...
	implements ICFBamInt64TypeTable
{
	...
	public void createInt64Type( ICFSecAuthorization Authorization,
		ICFBamInt64Type Buff )
	{
		...
		CFBamBuffInt64TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryInt64Type().newSchemaIdxKey();
	...
	public ICFBamInt64Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamInt64Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffInt64TypeBySchemaIdxKey key = schema.getFactoryInt64Type().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamInt64Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamInt64Type readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt64Type lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt64Type[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamInt64Type readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamInt64Type readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamInt64Type[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamInt64Type[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamInt64Type[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt64Type[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt64Type[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt64Type[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt64Type[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamInt64Type[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	...
	public void updateInt64Type( ICFSecAuthorization Authorization,
		ICFBamInt64Type Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamInt64Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt64TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryInt64Type().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffInt64TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryInt64Type().newSchemaIdxKey();
		...
		ICFBamInt64TypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<ICFBamInt64Type> matchSet = new LinkedList<ICFBamInt64Type>();
		Iterator<ICFBamInt64Type> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamInt64Type> iterMatch = matchSet.iterator();
