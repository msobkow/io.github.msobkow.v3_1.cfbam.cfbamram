	...
	implements ICFBamDateTypeTable
{
	...
	public void createDateType( ICFSecAuthorization Authorization,
		ICFBamDateType Buff )
	{
		...
		CFBamBuffDateTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryDateType().newSchemaIdxKey();
	...
	public ICFBamDateType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamDateType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDateTypeBySchemaIdxKey key = schema.getFactoryDateType().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamDateType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamDateType readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDateType lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDateType[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamDateType readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamDateType readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamDateType[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamDateType[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamDateType[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDateType[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDateType[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDateType[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDateType[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamDateType[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamDateType moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamDateType moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateDateType( ICFSecAuthorization Authorization,
		ICFBamDateType Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamDateType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDateTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryDateType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDateTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryDateType().newSchemaIdxKey();
		...
		ICFBamDateTypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<ICFBamDateType> matchSet = new LinkedList<ICFBamDateType>();
		Iterator<ICFBamDateType> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamDateType> iterMatch = matchSet.iterator();
