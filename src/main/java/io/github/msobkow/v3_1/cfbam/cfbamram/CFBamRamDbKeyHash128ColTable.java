	...
	implements ICFBamDbKeyHash128ColTable
{
	...
	public void createDbKeyHash128Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Col Buff )
	{
		...
		CFBamBuffDbKeyHash128ColByTableIdxKey keyTableIdx = schema.getFactoryDbKeyHash128Col().newTableIdxKey();
	...
	public ICFBamDbKeyHash128Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamDbKeyHash128Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash128ColByTableIdxKey key = schema.getFactoryDbKeyHash128Col().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamDbKeyHash128Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamDbKeyHash128Col readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash128Col lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash128Col[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamDbKeyHash128Col readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamDbKeyHash128Col readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamDbKeyHash128Col[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamDbKeyHash128Col[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamDbKeyHash128Col[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash128Col[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash128Col[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash128Col[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash128Col[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamDbKeyHash128Col[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	...
	public void updateDbKeyHash128Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Col Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamDbKeyHash128Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash128ColByTableIdxKey existingKeyTableIdx = schema.getFactoryDbKeyHash128Col().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash128ColByTableIdxKey newKeyTableIdx = schema.getFactoryDbKeyHash128Col().newTableIdxKey();
	...
	{
		ICFBamDbKeyHash128Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamDbKeyHash128Col> matchSet = new LinkedList<ICFBamDbKeyHash128Col>();
		Iterator<ICFBamDbKeyHash128Col> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamDbKeyHash128Col> iterMatch = matchSet.iterator();
