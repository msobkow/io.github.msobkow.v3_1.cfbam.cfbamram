	...
	implements ICFBamUuid6TypeTable
{
	...
	public void createUuid6Type( ICFSecAuthorization Authorization,
		ICFBamUuid6Type Buff )
	{
		...
		CFBamBuffUuid6TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryUuid6Type().newSchemaIdxKey();
	...
	public ICFBamUuid6Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamUuid6Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffUuid6TypeBySchemaIdxKey key = schema.getFactoryUuid6Type().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamUuid6Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamUuid6Type readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUuid6Type lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUuid6Type[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamUuid6Type readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamUuid6Type readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamUuid6Type[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamUuid6Type[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamUuid6Type[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUuid6Type[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUuid6Type[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUuid6Type[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUuid6Type[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamUuid6Type[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamUuid6Type moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamUuid6Type moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateUuid6Type( ICFSecAuthorization Authorization,
		ICFBamUuid6Type Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamUuid6Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUuid6TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryUuid6Type().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffUuid6TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryUuid6Type().newSchemaIdxKey();
		...
		ICFBamUuid6TypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<ICFBamUuid6Type> matchSet = new LinkedList<ICFBamUuid6Type>();
		Iterator<ICFBamUuid6Type> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamUuid6Type> iterMatch = matchSet.iterator();
