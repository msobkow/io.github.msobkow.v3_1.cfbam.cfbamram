	...
	implements ICFBamInt32ColTable
{
	...
	public void createInt32Col( ICFSecAuthorization Authorization,
		ICFBamInt32Col Buff )
	{
		...
		CFBamBuffInt32ColByTableIdxKey keyTableIdx = schema.getFactoryInt32Col().newTableIdxKey();
	...
	public ICFBamInt32Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamInt32Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffInt32ColByTableIdxKey key = schema.getFactoryInt32Col().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamInt32Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamInt32Col readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt32Col lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt32Col[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamInt32Col readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamInt32Col readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamInt32Col[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamInt32Col[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamInt32Col[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt32Col[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt32Col[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt32Col[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt32Col[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamInt32Col[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamInt32Col moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamInt32Col moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateInt32Col( ICFSecAuthorization Authorization,
		ICFBamInt32Col Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamInt32Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt32ColByTableIdxKey existingKeyTableIdx = schema.getFactoryInt32Col().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffInt32ColByTableIdxKey newKeyTableIdx = schema.getFactoryInt32Col().newTableIdxKey();
		...
		ICFBamInt32ColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamInt32Col> matchSet = new LinkedList<ICFBamInt32Col>();
		Iterator<ICFBamInt32Col> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamInt32Col> iterMatch = matchSet.iterator();
