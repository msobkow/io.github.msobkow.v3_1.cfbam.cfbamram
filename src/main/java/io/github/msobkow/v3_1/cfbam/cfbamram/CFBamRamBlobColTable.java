	...
	implements ICFBamBlobColTable
{
	...
	public void createBlobCol( ICFSecAuthorization Authorization,
		ICFBamBlobCol Buff )
	{
		...
		CFBamBuffBlobColByTableIdxKey keyTableIdx = schema.getFactoryBlobCol().newTableIdxKey();
	...
	public ICFBamBlobCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamBlobCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffBlobColByTableIdxKey key = schema.getFactoryBlobCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamBlobCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamBlobCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamBlobCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamBlobCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamBlobCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamBlobCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamBlobCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamBlobCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamBlobCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamBlobCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamBlobCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamBlobCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamBlobCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamBlobCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamBlobCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamBlobCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateBlobCol( ICFSecAuthorization Authorization,
		ICFBamBlobCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamBlobCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffBlobColByTableIdxKey existingKeyTableIdx = schema.getFactoryBlobCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffBlobColByTableIdxKey newKeyTableIdx = schema.getFactoryBlobCol().newTableIdxKey();
		...
		ICFBamBlobColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamBlobCol> matchSet = new LinkedList<ICFBamBlobCol>();
		Iterator<ICFBamBlobCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamBlobCol> iterMatch = matchSet.iterator();
