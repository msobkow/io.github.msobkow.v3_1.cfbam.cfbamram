	...
	implements ICFBamDbKeyHash512ColTable
{
	...
	public void createDbKeyHash512Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Col Buff )
	{
		...
		CFBamBuffDbKeyHash512ColByTableIdxKey keyTableIdx = schema.getFactoryDbKeyHash512Col().newTableIdxKey();
	...
	public ICFBamDbKeyHash512Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamDbKeyHash512Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDbKeyHash512ColByTableIdxKey key = schema.getFactoryDbKeyHash512Col().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamDbKeyHash512Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamDbKeyHash512Col readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash512Col lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash512Col[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamDbKeyHash512Col readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamDbKeyHash512Col readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamDbKeyHash512Col[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamDbKeyHash512Col[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamDbKeyHash512Col[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash512Col[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash512Col[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash512Col[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash512Col[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamDbKeyHash512Col[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamDbKeyHash512Col moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamDbKeyHash512Col moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateDbKeyHash512Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Col Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamDbKeyHash512Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash512ColByTableIdxKey existingKeyTableIdx = schema.getFactoryDbKeyHash512Col().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDbKeyHash512ColByTableIdxKey newKeyTableIdx = schema.getFactoryDbKeyHash512Col().newTableIdxKey();
	...
	{
		ICFBamDbKeyHash512Col cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamDbKeyHash512Col> matchSet = new LinkedList<ICFBamDbKeyHash512Col>();
		Iterator<ICFBamDbKeyHash512Col> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamDbKeyHash512Col> iterMatch = matchSet.iterator();
