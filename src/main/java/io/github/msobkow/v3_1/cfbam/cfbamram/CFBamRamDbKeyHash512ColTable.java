	...
	implements ICFBamDbKeyHash512ColTable
{
	...
	public ICFBamDbKeyHash512Col updateDbKeyHash512Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash512Col iBuff )
	{
		CFBamBuffDbKeyHash512Col Buff = (CFBamBuffDbKeyHash512Col)schema.getTableDbKeyHash512Def().updateDbKeyHash512Def( Authorization,	Buff );
		...
		ICFBamDbKeyHash512Col iBuff )
	{
		...
		CFBamBuffDbKeyHash512Col Buff = ensureRec(iBuff);
		int classCode;
