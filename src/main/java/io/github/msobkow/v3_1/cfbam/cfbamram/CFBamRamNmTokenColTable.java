	...
	implements ICFBamNmTokenColTable
{
	...
	public void createNmTokenCol( ICFSecAuthorization Authorization,
		ICFBamNmTokenCol Buff )
	{
		...
		CFBamBuffNmTokenColByTableIdxKey keyTableIdx = schema.getFactoryNmTokenCol().newTableIdxKey();
	...
	public ICFBamNmTokenCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamNmTokenCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffNmTokenColByTableIdxKey key = schema.getFactoryNmTokenCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamNmTokenCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamNmTokenCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamNmTokenCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamNmTokenCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamNmTokenCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamNmTokenCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamNmTokenCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamNmTokenCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamNmTokenCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamNmTokenCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamNmTokenCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamNmTokenCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamNmTokenCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamNmTokenCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamNmTokenCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamNmTokenCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateNmTokenCol( ICFSecAuthorization Authorization,
		ICFBamNmTokenCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamNmTokenCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffNmTokenColByTableIdxKey existingKeyTableIdx = schema.getFactoryNmTokenCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNmTokenColByTableIdxKey newKeyTableIdx = schema.getFactoryNmTokenCol().newTableIdxKey();
	...
	{
		ICFBamNmTokenCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamNmTokenCol> matchSet = new LinkedList<ICFBamNmTokenCol>();
		Iterator<ICFBamNmTokenCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamNmTokenCol> iterMatch = matchSet.iterator();
