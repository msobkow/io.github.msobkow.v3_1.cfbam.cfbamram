	...
	implements ICFBamNmTokensColTable
{
	...
	public void createNmTokensCol( ICFSecAuthorization Authorization,
		ICFBamNmTokensCol Buff )
	{
		...
		CFBamBuffNmTokensColByTableIdxKey keyTableIdx = schema.getFactoryNmTokensCol().newTableIdxKey();
	...
	public ICFBamNmTokensCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamNmTokensCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffNmTokensColByTableIdxKey key = schema.getFactoryNmTokensCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamNmTokensCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamNmTokensCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamNmTokensCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamNmTokensCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamNmTokensCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamNmTokensCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamNmTokensCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamNmTokensCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamNmTokensCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamNmTokensCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamNmTokensCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamNmTokensCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamNmTokensCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamNmTokensCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamNmTokensCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamNmTokensCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateNmTokensCol( ICFSecAuthorization Authorization,
		ICFBamNmTokensCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamNmTokensCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffNmTokensColByTableIdxKey existingKeyTableIdx = schema.getFactoryNmTokensCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNmTokensColByTableIdxKey newKeyTableIdx = schema.getFactoryNmTokensCol().newTableIdxKey();
	...
	{
		ICFBamNmTokensCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamNmTokensCol> matchSet = new LinkedList<ICFBamNmTokensCol>();
		Iterator<ICFBamNmTokensCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamNmTokensCol> iterMatch = matchSet.iterator();
