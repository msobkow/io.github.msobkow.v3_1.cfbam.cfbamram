	...
	implements ICFBamNmTokensColTable
{
	...
	public ICFBamNmTokensCol updateNmTokensCol( ICFSecAuthorization Authorization,
		ICFBamNmTokensCol iBuff )
	{
		CFBamBuffNmTokensCol Buff = (CFBamBuffNmTokensCol)schema.getTableNmTokensDef().updateNmTokensDef( Authorization,	Buff );
		...
		ICFBamNmTokensCol iBuff )
	{
		...
		CFBamBuffNmTokensCol Buff = ensureRec(iBuff);
		int classCode;
