	...
	implements ICFBamDbKeyHash384GenTable
{
	...
	public ICFBamDbKeyHash384Gen updateDbKeyHash384Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash384Gen iBuff )
	{
		CFBamBuffDbKeyHash384Gen Buff = (CFBamBuffDbKeyHash384Gen)schema.getTableDbKeyHash384Type().updateDbKeyHash384Type( Authorization,	Buff );
		...
		ICFBamDbKeyHash384Gen iBuff )
	{
		...
		CFBamBuffDbKeyHash384Gen Buff = ensureRec(iBuff);
		int classCode;
