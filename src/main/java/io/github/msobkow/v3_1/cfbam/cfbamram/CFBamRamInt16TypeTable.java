	...
	implements ICFBamInt16TypeTable
{
	...
	public void createInt16Type( ICFSecAuthorization Authorization,
		ICFBamInt16Type Buff )
	{
		...
		CFBamBuffInt16TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryInt16Type().newSchemaIdxKey();
	...
	public ICFBamInt16Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamInt16Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffInt16TypeBySchemaIdxKey key = schema.getFactoryInt16Type().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamInt16Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamInt16Type readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt16Type lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt16Type[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamInt16Type readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamInt16Type readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamInt16Type[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamInt16Type[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamInt16Type[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt16Type[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt16Type[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt16Type[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt16Type[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamInt16Type[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamInt16Type moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamInt16Type moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateInt16Type( ICFSecAuthorization Authorization,
		ICFBamInt16Type Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamInt16Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt16TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryInt16Type().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffInt16TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryInt16Type().newSchemaIdxKey();
		...
		ICFBamInt16TypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<ICFBamInt16Type> matchSet = new LinkedList<ICFBamInt16Type>();
		Iterator<ICFBamInt16Type> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamInt16Type> iterMatch = matchSet.iterator();
