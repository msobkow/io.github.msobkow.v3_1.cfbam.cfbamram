	...
	implements ICFBamNmTokenTypeTable
{
	...
	public void createNmTokenType( ICFSecAuthorization Authorization,
		ICFBamNmTokenType Buff )
	{
		...
		CFBamBuffNmTokenTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryNmTokenType().newSchemaIdxKey();
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffNmTokenTypeBySchemaIdxKey key = schema.getFactoryNmTokenType().newSchemaIdxKey();
	...
	public void updateNmTokenType( ICFSecAuthorization Authorization,
		ICFBamNmTokenType Buff )
	{
		...
		CFBamBuffNmTokenTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryNmTokenType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffNmTokenTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryNmTokenType().newSchemaIdxKey();
