	...
	implements ICFBamServiceTypeTable
{
	...
	public ICFSecServiceType lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamServiceType.lockDerived";
		ICFSecServiceType buff;
		if( dictByPKey.containsKey( PKey ) ) {
			buff = dictByPKey.get( PKey );
		}
	...
	public ICFSecServiceType readRec( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		final String S_ProcName = "CFBamRamServiceType.readRec";
	...
	{
		final String S_ProcName = "CFBamRamServiceType.readAllRec";
		ICFSecServiceType buff;
	...
	public ICFSecServiceType readRecByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ServiceTypeId )
	{
		final String S_ProcName = "CFBamRamServiceType.readRecByIdIdx() ";
	...
	public ICFSecServiceType readRecByUDescrIdx( ICFSecAuthorization Authorization,
		String Description )
	{
		final String S_ProcName = "CFBamRamServiceType.readRecByUDescrIdx() ";
