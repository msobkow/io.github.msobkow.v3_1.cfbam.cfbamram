	...
	implements ICFBamUInt16DefTable
{
	...
	public ICFBamUInt16Def updateUInt16Def( ICFSecAuthorization Authorization,
		ICFBamUInt16Def iBuff )
	{
		CFBamBuffUInt16Def Buff = (CFBamBuffUInt16Def)schema.getTableAtom().updateAtom( Authorization,	Buff );
		...
		ICFBamUInt16Def iBuff )
	{
		...
		CFBamBuffUInt16Def Buff = ensureRec(iBuff);
		int classCode;
		...
		CFLibDbKeyHash256 argKey )
	{
		...
		while( iterMatch.hasNext() ) {
			...
			if( CFBamUInt16Def.CLASS_CODE == subClassCode ) {
