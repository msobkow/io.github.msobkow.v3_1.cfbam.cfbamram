	...
	implements ICFBamInt16ColTable
{
	...
	public void createInt16Col( ICFSecAuthorization Authorization,
		ICFBamInt16Col Buff )
	{
		...
		CFBamBuffInt16ColByTableIdxKey keyTableIdx = schema.getFactoryInt16Col().newTableIdxKey();
	...
	public ICFBamInt16Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamInt16Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffInt16ColByTableIdxKey key = schema.getFactoryInt16Col().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamInt16Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamInt16Col readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt16Col lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamInt16Col[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamInt16Col readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamInt16Col readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamInt16Col[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamInt16Col[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamInt16Col[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt16Col[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt16Col[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamInt16Col[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamInt16Col[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamInt16Col[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamInt16Col moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamInt16Col moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateInt16Col( ICFSecAuthorization Authorization,
		ICFBamInt16Col Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamInt16Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffInt16ColByTableIdxKey existingKeyTableIdx = schema.getFactoryInt16Col().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffInt16ColByTableIdxKey newKeyTableIdx = schema.getFactoryInt16Col().newTableIdxKey();
		...
		ICFBamInt16ColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamInt16Col> matchSet = new LinkedList<ICFBamInt16Col>();
		Iterator<ICFBamInt16Col> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamInt16Col> iterMatch = matchSet.iterator();
