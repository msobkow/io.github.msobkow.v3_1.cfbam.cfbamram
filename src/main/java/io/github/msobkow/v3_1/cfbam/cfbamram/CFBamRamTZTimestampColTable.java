	...
	implements ICFBamTZTimestampColTable
{
	...
	public void createTZTimestampCol( ICFSecAuthorization Authorization,
		ICFBamTZTimestampCol Buff )
	{
		...
		CFBamBuffTZTimestampColByTableIdxKey keyTableIdx = schema.getFactoryTZTimestampCol().newTableIdxKey();
	...
	public ICFBamTZTimestampCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamTZTimestampCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTZTimestampColByTableIdxKey key = schema.getFactoryTZTimestampCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamTZTimestampCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamTZTimestampCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTZTimestampCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTZTimestampCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamTZTimestampCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamTZTimestampCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamTZTimestampCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamTZTimestampCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamTZTimestampCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTZTimestampCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTZTimestampCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTZTimestampCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTZTimestampCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamTZTimestampCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamTZTimestampCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamTZTimestampCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateTZTimestampCol( ICFSecAuthorization Authorization,
		ICFBamTZTimestampCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamTZTimestampCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTZTimestampColByTableIdxKey existingKeyTableIdx = schema.getFactoryTZTimestampCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTZTimestampColByTableIdxKey newKeyTableIdx = schema.getFactoryTZTimestampCol().newTableIdxKey();
	...
	{
		ICFBamTZTimestampCol cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamTZTimestampCol> matchSet = new LinkedList<ICFBamTZTimestampCol>();
		Iterator<ICFBamTZTimestampCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamTZTimestampCol> iterMatch = matchSet.iterator();
