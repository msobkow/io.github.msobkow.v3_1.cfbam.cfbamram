	...
	implements ICFBamTZTimestampColTable
{
	...
	public ICFBamTZTimestampCol updateTZTimestampCol( ICFSecAuthorization Authorization,
		ICFBamTZTimestampCol iBuff )
	{
		CFBamBuffTZTimestampCol Buff = (CFBamBuffTZTimestampCol)schema.getTableTZTimestampDef().updateTZTimestampDef( Authorization,	Buff );
		...
		ICFBamTZTimestampCol iBuff )
	{
		...
		CFBamBuffTZTimestampCol Buff = ensureRec(iBuff);
		int classCode;
