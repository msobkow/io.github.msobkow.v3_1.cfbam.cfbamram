	...
	implements ICFBamTextColTable
{
	...
	public void createTextCol( ICFSecAuthorization Authorization,
		ICFBamTextCol Buff )
	{
		...
		CFBamBuffTextColByTableIdxKey keyTableIdx = schema.getFactoryTextCol().newTableIdxKey();
	...
	public ICFBamTextCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamTextCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffTextColByTableIdxKey key = schema.getFactoryTextCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamTextCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamTextCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTextCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTextCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamTextCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamTextCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamTextCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamTextCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamTextCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTextCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTextCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTextCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTextCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamTextCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamTextCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamTextCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateTextCol( ICFSecAuthorization Authorization,
		ICFBamTextCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamTextCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTextColByTableIdxKey existingKeyTableIdx = schema.getFactoryTextCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffTextColByTableIdxKey newKeyTableIdx = schema.getFactoryTextCol().newTableIdxKey();
		...
		ICFBamTextColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamTextCol> matchSet = new LinkedList<ICFBamTextCol>();
		Iterator<ICFBamTextCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamTextCol> iterMatch = matchSet.iterator();
