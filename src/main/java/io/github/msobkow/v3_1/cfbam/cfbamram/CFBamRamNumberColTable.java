	...
	implements ICFBamNumberColTable
{
	...
	public void createNumberCol( ICFSecAuthorization Authorization,
		ICFBamNumberCol Buff )
	{
		...
		CFBamBuffNumberColByTableIdxKey keyTableIdx = schema.getFactoryNumberCol().newTableIdxKey();
	...
	public ICFBamNumberCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamNumberCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffNumberColByTableIdxKey key = schema.getFactoryNumberCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamNumberCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamNumberCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamNumberCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamNumberCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamNumberCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamNumberCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamNumberCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamNumberCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamNumberCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamNumberCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamNumberCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamNumberCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamNumberCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamNumberCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamNumberCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamNumberCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateNumberCol( ICFSecAuthorization Authorization,
		ICFBamNumberCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamNumberCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffNumberColByTableIdxKey existingKeyTableIdx = schema.getFactoryNumberCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffNumberColByTableIdxKey newKeyTableIdx = schema.getFactoryNumberCol().newTableIdxKey();
		...
		ICFBamNumberColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamNumberCol> matchSet = new LinkedList<ICFBamNumberCol>();
		Iterator<ICFBamNumberCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamNumberCol> iterMatch = matchSet.iterator();
