	...
	implements ICFBamDoubleColTable
{
	...
	public void createDoubleCol( ICFSecAuthorization Authorization,
		ICFBamDoubleCol Buff )
	{
		...
		CFBamBuffDoubleColByTableIdxKey keyTableIdx = schema.getFactoryDoubleCol().newTableIdxKey();
	...
	public ICFBamDoubleCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamDoubleCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffDoubleColByTableIdxKey key = schema.getFactoryDoubleCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamDoubleCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamDoubleCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDoubleCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDoubleCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamDoubleCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamDoubleCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamDoubleCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamDoubleCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamDoubleCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDoubleCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDoubleCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDoubleCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDoubleCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamDoubleCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamDoubleCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamDoubleCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateDoubleCol( ICFSecAuthorization Authorization,
		ICFBamDoubleCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamDoubleCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDoubleColByTableIdxKey existingKeyTableIdx = schema.getFactoryDoubleCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffDoubleColByTableIdxKey newKeyTableIdx = schema.getFactoryDoubleCol().newTableIdxKey();
		...
		ICFBamDoubleColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamDoubleCol> matchSet = new LinkedList<ICFBamDoubleCol>();
		Iterator<ICFBamDoubleCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamDoubleCol> iterMatch = matchSet.iterator();
