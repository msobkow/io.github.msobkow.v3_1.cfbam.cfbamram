	...
	implements ICFBamUuid6ColTable
{
	...
	public void createUuid6Col( ICFSecAuthorization Authorization,
		ICFBamUuid6Col Buff )
	{
		...
		CFBamBuffUuid6ColByTableIdxKey keyTableIdx = schema.getFactoryUuid6Col().newTableIdxKey();
	...
	public ICFBamUuid6Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamUuid6Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffUuid6ColByTableIdxKey key = schema.getFactoryUuid6Col().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamUuid6Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamUuid6Col readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUuid6Col lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUuid6Col[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamUuid6Col readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamUuid6Col readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamUuid6Col[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamUuid6Col[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamUuid6Col[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUuid6Col[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUuid6Col[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUuid6Col[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUuid6Col[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamUuid6Col[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamUuid6Col moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamUuid6Col moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateUuid6Col( ICFSecAuthorization Authorization,
		ICFBamUuid6Col Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamUuid6Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUuid6ColByTableIdxKey existingKeyTableIdx = schema.getFactoryUuid6Col().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUuid6ColByTableIdxKey newKeyTableIdx = schema.getFactoryUuid6Col().newTableIdxKey();
		...
		ICFBamUuid6ColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamUuid6Col> matchSet = new LinkedList<ICFBamUuid6Col>();
		Iterator<ICFBamUuid6Col> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamUuid6Col> iterMatch = matchSet.iterator();
