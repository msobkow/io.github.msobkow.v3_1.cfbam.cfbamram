	...
	implements ICFBamNmTokensTypeTable
{
	...
	public ICFBamNmTokensType updateNmTokensType( ICFSecAuthorization Authorization,
		ICFBamNmTokensType iBuff )
	{
		CFBamBuffNmTokensType Buff = (CFBamBuffNmTokensType)schema.getTableNmTokensDef().updateNmTokensDef( Authorization,	Buff );
		...
		ICFBamNmTokensType iBuff )
	{
		...
		CFBamBuffNmTokensType Buff = ensureRec(iBuff);
		int classCode;
