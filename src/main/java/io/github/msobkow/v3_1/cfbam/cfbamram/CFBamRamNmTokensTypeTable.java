	...
	implements ICFBamNmTokensTypeTable
{
	...
	public void createNmTokensType( ICFSecAuthorization Authorization,
		ICFBamNmTokensType Buff )
	{
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryNmTokensType().newSchemaIdxKey();
	...
	public ICFBamNmTokensType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamNmTokensType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey key = schema.getFactoryNmTokensType().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamNmTokensType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamNmTokensType readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamNmTokensType lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamNmTokensType[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamNmTokensType readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamNmTokensType readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamNmTokensType[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamNmTokensType[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamNmTokensType[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamNmTokensType[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamNmTokensType[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamNmTokensType[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamNmTokensType[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamNmTokensType[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamNmTokensType moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamNmTokensType moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateNmTokensType( ICFSecAuthorization Authorization,
		ICFBamNmTokensType Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamNmTokensType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffNmTokensTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryNmTokensType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffNmTokensTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryNmTokensType().newSchemaIdxKey();
	...
	{
		ICFBamNmTokensType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamNmTokensType> matchSet = new LinkedList<ICFBamNmTokensType>();
		Iterator<ICFBamNmTokensType> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamNmTokensType> iterMatch = matchSet.iterator();
