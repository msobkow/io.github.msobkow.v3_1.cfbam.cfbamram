	...
	implements ICFBamDoubleTypeTable
{
	...
	public void createDoubleType( ICFSecAuthorization Authorization,
		ICFBamDoubleType Buff )
	{
		...
		CFBamBuffDoubleTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryDoubleType().newSchemaIdxKey();
	...
	public ICFBamDoubleType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamDoubleType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDoubleTypeBySchemaIdxKey key = schema.getFactoryDoubleType().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamDoubleType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamDoubleType readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDoubleType lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDoubleType[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamDoubleType readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamDoubleType readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamDoubleType[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamDoubleType[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamDoubleType[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDoubleType[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDoubleType[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDoubleType[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDoubleType[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamDoubleType[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamDoubleType moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamDoubleType moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateDoubleType( ICFSecAuthorization Authorization,
		ICFBamDoubleType Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamDoubleType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDoubleTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryDoubleType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDoubleTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryDoubleType().newSchemaIdxKey();
	...
	{
		ICFBamDoubleType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamDoubleType> matchSet = new LinkedList<ICFBamDoubleType>();
		Iterator<ICFBamDoubleType> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamDoubleType> iterMatch = matchSet.iterator();
