	...
	implements ICFBamTZTimeTypeTable
{
	...
	public void createTZTimeType( ICFSecAuthorization Authorization,
		ICFBamTZTimeType Buff )
	{
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryTZTimeType().newSchemaIdxKey();
	...
	public ICFBamTZTimeType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamTZTimeType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey key = schema.getFactoryTZTimeType().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamTZTimeType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamTZTimeType readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTZTimeType lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTZTimeType[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamTZTimeType readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamTZTimeType readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamTZTimeType[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamTZTimeType[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamTZTimeType[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTZTimeType[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTZTimeType[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTZTimeType[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTZTimeType[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamTZTimeType[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamTZTimeType moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamTZTimeType moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateTZTimeType( ICFSecAuthorization Authorization,
		ICFBamTZTimeType Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamTZTimeType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTZTimeTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryTZTimeType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTZTimeTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryTZTimeType().newSchemaIdxKey();
	...
	{
		ICFBamTZTimeType cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamTZTimeType> matchSet = new LinkedList<ICFBamTZTimeType>();
		Iterator<ICFBamTZTimeType> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamTZTimeType> iterMatch = matchSet.iterator();
