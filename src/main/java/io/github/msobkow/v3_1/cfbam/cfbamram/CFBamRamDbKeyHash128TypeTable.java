	...
	implements ICFBamDbKeyHash128TypeTable
{
	...
	public void createDbKeyHash128Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Type Buff )
	{
		...
		CFBamBuffDbKeyHash128TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryDbKeyHash128Type().newSchemaIdxKey();
	...
	public ICFBamDbKeyHash128Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamDbKeyHash128Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash128TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash128Type().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamDbKeyHash128Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamDbKeyHash128Type readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash128Type lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash128Type[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamDbKeyHash128Type readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamDbKeyHash128Type readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamDbKeyHash128Type[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamDbKeyHash128Type[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamDbKeyHash128Type[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash128Type[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash128Type[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash128Type[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash128Type[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamDbKeyHash128Type[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamDbKeyHash128Type moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamDbKeyHash128Type moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateDbKeyHash128Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Type Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamDbKeyHash128Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash128TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryDbKeyHash128Type().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash128TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryDbKeyHash128Type().newSchemaIdxKey();
		...
		ICFBamDbKeyHash128TypeBySchemaIdxKey argKey )
	{
		...
		ICFBamDbKeyHash128Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamDbKeyHash128Type> matchSet = new LinkedList<ICFBamDbKeyHash128Type>();
		Iterator<ICFBamDbKeyHash128Type> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamDbKeyHash128Type> iterMatch = matchSet.iterator();
