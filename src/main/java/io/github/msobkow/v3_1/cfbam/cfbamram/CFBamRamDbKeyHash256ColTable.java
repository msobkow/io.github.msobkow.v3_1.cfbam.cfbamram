	...
	implements ICFBamDbKeyHash256ColTable
{
	...
	public ICFBamDbKeyHash256Col updateDbKeyHash256Col( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Col iBuff )
	{
		CFBamBuffDbKeyHash256Col Buff = (CFBamBuffDbKeyHash256Col)schema.getTableDbKeyHash256Def().updateDbKeyHash256Def( Authorization,	Buff );
		...
		ICFBamDbKeyHash256Col iBuff )
	{
		...
		CFBamBuffDbKeyHash256Col Buff = ensureRec(iBuff);
		int classCode;
