	...
	implements ICFBamTimeTypeTable
{
	...
	public void createTimeType( ICFSecAuthorization Authorization,
		ICFBamTimeType Buff )
	{
		...
		CFBamBuffTimeTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryTimeType().newSchemaIdxKey();
	...
	public ICFBamTimeType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamTimeType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTimeTypeBySchemaIdxKey key = schema.getFactoryTimeType().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamTimeType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	 ...
	 */
	public ICFBamTimeType moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamTimeType moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateTimeType( ICFSecAuthorization Authorization,
		ICFBamTimeType Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamTimeType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTimeTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryTimeType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTimeTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryTimeType().newSchemaIdxKey();
		...
		ICFBamTimeTypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<ICFBamTimeType> matchSet = new LinkedList<ICFBamTimeType>();
		Iterator<ICFBamTimeType> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamTimeType> iterMatch = matchSet.iterator();
