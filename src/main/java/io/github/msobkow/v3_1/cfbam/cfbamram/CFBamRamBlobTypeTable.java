	...
	implements ICFBamBlobTypeTable
{
	...
	public void createBlobType( ICFSecAuthorization Authorization,
		ICFBamBlobType Buff )
	{
		...
		CFBamBuffBlobTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryBlobType().newSchemaIdxKey();
	...
	public ICFBamBlobType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamBlobType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffBlobTypeBySchemaIdxKey key = schema.getFactoryBlobType().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamBlobType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamBlobType readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamBlobType lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamBlobType[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamBlobType readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamBlobType readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamBlobType[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamBlobType[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamBlobType[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamBlobType[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamBlobType[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamBlobType[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamBlobType[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamBlobType[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamBlobType moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamBlobType moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateBlobType( ICFSecAuthorization Authorization,
		ICFBamBlobType Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamBlobType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffBlobTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryBlobType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffBlobTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryBlobType().newSchemaIdxKey();
		...
		ICFBamBlobTypeBySchemaIdxKey argKey )
	{
		...
		LinkedList<ICFBamBlobType> matchSet = new LinkedList<ICFBamBlobType>();
		Iterator<ICFBamBlobType> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamBlobType> iterMatch = matchSet.iterator();
