	...
	implements ICFBamFloatColTable
{
	...
	public void createFloatCol( ICFSecAuthorization Authorization,
		ICFBamFloatCol Buff )
	{
		...
		CFBamBuffFloatColByTableIdxKey keyTableIdx = schema.getFactoryFloatCol().newTableIdxKey();
	...
	public ICFBamFloatCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamFloatCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffFloatColByTableIdxKey key = schema.getFactoryFloatCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamFloatCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamFloatCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamFloatCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamFloatCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamFloatCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamFloatCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamFloatCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamFloatCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamFloatCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamFloatCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamFloatCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamFloatCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamFloatCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamFloatCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamFloatCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamFloatCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateFloatCol( ICFSecAuthorization Authorization,
		ICFBamFloatCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamFloatCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffFloatColByTableIdxKey existingKeyTableIdx = schema.getFactoryFloatCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffFloatColByTableIdxKey newKeyTableIdx = schema.getFactoryFloatCol().newTableIdxKey();
		...
		ICFBamFloatColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamFloatCol> matchSet = new LinkedList<ICFBamFloatCol>();
		Iterator<ICFBamFloatCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamFloatCol> iterMatch = matchSet.iterator();
