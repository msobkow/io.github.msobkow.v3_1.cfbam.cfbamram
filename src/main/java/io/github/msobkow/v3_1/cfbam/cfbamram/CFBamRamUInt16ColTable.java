	...
	implements ICFBamUInt16ColTable
{
	...
	public void createUInt16Col( ICFSecAuthorization Authorization,
		ICFBamUInt16Col Buff )
	{
		...
		CFBamBuffUInt16ColByTableIdxKey keyTableIdx = schema.getFactoryUInt16Col().newTableIdxKey();
	...
	public ICFBamUInt16Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamUInt16Col > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffUInt16ColByTableIdxKey key = schema.getFactoryUInt16Col().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamUInt16Col > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamUInt16Col readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUInt16Col lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUInt16Col[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamUInt16Col readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamUInt16Col readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamUInt16Col[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamUInt16Col[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamUInt16Col[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUInt16Col[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUInt16Col[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUInt16Col[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUInt16Col[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamUInt16Col[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamUInt16Col moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamUInt16Col moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateUInt16Col( ICFSecAuthorization Authorization,
		ICFBamUInt16Col Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamUInt16Col existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUInt16ColByTableIdxKey existingKeyTableIdx = schema.getFactoryUInt16Col().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUInt16ColByTableIdxKey newKeyTableIdx = schema.getFactoryUInt16Col().newTableIdxKey();
		...
		ICFBamUInt16ColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamUInt16Col> matchSet = new LinkedList<ICFBamUInt16Col>();
		Iterator<ICFBamUInt16Col> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamUInt16Col> iterMatch = matchSet.iterator();
