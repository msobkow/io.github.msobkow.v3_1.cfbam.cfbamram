	...
	implements ICFBamUuidColTable
{
	...
	public void createUuidCol( ICFSecAuthorization Authorization,
		ICFBamUuidCol Buff )
	{
		...
		CFBamBuffUuidColByTableIdxKey keyTableIdx = schema.getFactoryUuidCol().newTableIdxKey();
	...
	public ICFBamUuidCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamUuidCol > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 TableId )
	{
		...
		CFBamBuffUuidColByTableIdxKey key = schema.getFactoryUuidCol().newTableIdxKey();
		...
		if( dictByTableIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamUuidCol > iter = subdictTableIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamUuidCol readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUuidCol lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamUuidCol[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamUuidCol readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamUuidCol readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamUuidCol[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamUuidCol[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamUuidCol[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUuidCol[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUuidCol[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamUuidCol[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamUuidCol[] readBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId )
	{
	 ...
	 */
	public ICFBamUuidCol[] pageBuffByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 TableId,
	 ...
	 */
	public ICFBamUuidCol moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamUuidCol moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateUuidCol( ICFSecAuthorization Authorization,
		ICFBamUuidCol Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamUuidCol existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffUuidColByTableIdxKey existingKeyTableIdx = schema.getFactoryUuidCol().newTableIdxKey();
		existingKeyTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		CFBamBuffUuidColByTableIdxKey newKeyTableIdx = schema.getFactoryUuidCol().newTableIdxKey();
		...
		ICFBamUuidColByTableIdxKey argKey )
	{
		...
		LinkedList<ICFBamUuidCol> matchSet = new LinkedList<ICFBamUuidCol>();
		Iterator<ICFBamUuidCol> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamUuidCol> iterMatch = matchSet.iterator();
