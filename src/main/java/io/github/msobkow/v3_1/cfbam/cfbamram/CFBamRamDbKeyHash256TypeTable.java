	...
	implements ICFBamDbKeyHash256TypeTable
{
	...
	public ICFBamDbKeyHash256Type updateDbKeyHash256Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Type iBuff )
	{
		CFBamBuffDbKeyHash256Type Buff = (CFBamBuffDbKeyHash256Type)schema.getTableDbKeyHash256Def().updateDbKeyHash256Def( Authorization,	Buff );
		...
		ICFBamDbKeyHash256Type iBuff )
	{
		...
		CFBamBuffDbKeyHash256Type Buff = ensureRec(iBuff);
		int classCode;
