	...
	implements ICFBamDbKeyHash256TypeTable
{
	...
	public void createDbKeyHash256Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Type Buff )
	{
		...
		CFBamBuffDbKeyHash256TypeBySchemaIdxKey keySchemaIdx = schema.getFactoryDbKeyHash256Type().newSchemaIdxKey();
	...
	public ICFBamDbKeyHash256Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamDbKeyHash256Type > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffDbKeyHash256TypeBySchemaIdxKey key = schema.getFactoryDbKeyHash256Type().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamDbKeyHash256Type > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamDbKeyHash256Type readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash256Type lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamDbKeyHash256Type[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamDbKeyHash256Type readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamDbKeyHash256Type readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamDbKeyHash256Type[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamDbKeyHash256Type[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamDbKeyHash256Type[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash256Type[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash256Type[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamDbKeyHash256Type[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamDbKeyHash256Type[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamDbKeyHash256Type[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamDbKeyHash256Type moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamDbKeyHash256Type moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateDbKeyHash256Type( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Type Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamDbKeyHash256Type existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffDbKeyHash256TypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryDbKeyHash256Type().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffDbKeyHash256TypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryDbKeyHash256Type().newSchemaIdxKey();
		...
		ICFBamDbKeyHash256TypeBySchemaIdxKey argKey )
	{
		...
		ICFBamDbKeyHash256Type cur;
		boolean anyNotNull = false;
		anyNotNull = true;
		if( ! anyNotNull ) {
			return;
		}
		LinkedList<ICFBamDbKeyHash256Type> matchSet = new LinkedList<ICFBamDbKeyHash256Type>();
		Iterator<ICFBamDbKeyHash256Type> values = dictByPKey.values().iterator();
		...
		Iterator<ICFBamDbKeyHash256Type> iterMatch = matchSet.iterator();
