	...
	implements ICFBamTimestampTypeTable
{
	...
	public ICFBamTimestampType updateTimestampType( ICFSecAuthorization Authorization,
		ICFBamTimestampType iBuff )
	{
		CFBamBuffTimestampType Buff = (CFBamBuffTimestampType)schema.getTableTimestampDef().updateTimestampDef( Authorization,	Buff );
		...
		ICFBamTimestampType iBuff )
	{
		...
		CFBamBuffTimestampType Buff = ensureRec(iBuff);
		int classCode;
