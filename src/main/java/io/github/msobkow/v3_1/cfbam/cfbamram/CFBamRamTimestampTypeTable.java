	...
	implements ICFBamTimestampTypeTable
{
	...
	public void createTimestampType( ICFSecAuthorization Authorization,
		ICFBamTimestampType Buff )
	{
		...
		CFBamBuffTimestampTypeBySchemaIdxKey keySchemaIdx = schema.getFactoryTimestampType().newSchemaIdxKey();
	...
	public ICFBamTimestampType[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		Iterator< ICFBamTimestampType > iter = dictByPKey.values().iterator();
		int idx = 0;
		while( iter.hasNext() ) {
		...
		CFLibDbKeyHash256 SchemaDefId )
	{
		...
		CFBamBuffTimestampTypeBySchemaIdxKey key = schema.getFactoryTimestampType().newSchemaIdxKey();
		...
		if( dictBySchemaIdx.containsKey( key ) ) {
			...
			Iterator< ICFBamTimestampType > iter = subdictSchemaIdx.values().iterator();
			int idx = 0;
			while( iter.hasNext() ) {
	...
	public ICFBamTimestampType readBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTimestampType lockBuff( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
	...
	public ICFBamTimestampType[] readAllBuff( ICFSecAuthorization Authorization )
	{
	...
	public ICFBamTimestampType readBuffByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id )
	{
	...
	public ICFBamTimestampType readBuffByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name )
	{
	...
	public ICFBamTimestampType[] readBuffByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId )
	{
	...
	public ICFBamTimestampType[] readBuffByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId )
	{
	...
	public ICFBamTimestampType[] readBuffByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTimestampType[] readBuffByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTimestampType[] readBuffByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId )
	{
	...
	public ICFBamTimestampType[] readBuffByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId )
	{
	...
	public ICFBamTimestampType[] readBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId )
	{
	 ...
	 */
	public ICFBamTimestampType[] pageBuffBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId,
	 ...
	 */
	public ICFBamTimestampType moveBuffUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	 ...
	 *	@return	The refreshed buffer after it has been moved
	 */
	public ICFBamTimestampType moveBuffDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision )
	{
	...
	public void updateTimestampType( ICFSecAuthorization Authorization,
		ICFBamTimestampType Buff )
	{
		...
		CFLibDbKeyHash256 pkey = schema.getFactoryValue().newPKey();
		pkey.setRequiredId( Buff.getRequiredId() );
		ICFBamTimestampType existing = dictByPKey.get( pkey );
		if( existing == null ) {
		...
		CFBamBuffTimestampTypeBySchemaIdxKey existingKeySchemaIdx = schema.getFactoryTimestampType().newSchemaIdxKey();
		existingKeySchemaIdx.setRequiredSchemaDefId( existing.getRequiredSchemaDefId() );

		CFBamBuffTimestampTypeBySchemaIdxKey newKeySchemaIdx = schema.getFactoryTimestampType().newSchemaIdxKey();
